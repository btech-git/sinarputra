 ...
 */
class QualityControlCuttingHeaderBase extends MonthlyTransactionActiveRecord {

    public function tableName() {
        return 'tblsp_quality_control_cutting_header';
    }

    public function rules() {
        return array(
            array('cn_ordinal, cn_month, cn_year, date, production_cutting_header_id, work_order_cutting_header_id, admin_id', 'required'),
            array('cn_ordinal, cn_month, cn_year, production_cutting_header_id, work_order_cutting_header_id, admin_id, is_delivered, is_inactive, admin_id_updated', 'numerical', 'integerOnly' => true),
            array('note, created_datetime, updated_datetime', 'safe'),
            // The following rule is used by search().
            array('id, cn_ordinal, cn_month, cn_year, date, note, production_cutting_header_id, work_order_cutting_header_id, admin_id, is_delivered, is_inactive, admin_id_updated, created_datetime, updated_datetime', 'safe', 'on' => 'search'),
        );
    }

    public function relations() {
        return array(
            'deliveryHeaders' => array(self::HAS_MANY, 'DeliveryHeader', 'quality_control_cutting_header_id'),
            'qualityControlCuttingDetails' => array(self::HAS_MANY, 'QualityControlCuttingDetail', 'quality_control_cutting_header_id'),
            ...
            'workOrderReplacementHeaders' => array(self::HAS_MANY, 'WorkOrderReplacementHeader', 'quality_control_cutting_header_id'),
        );
    }
