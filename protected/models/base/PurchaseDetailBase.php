...
class PurchaseDetailBase extends ActiveRecord {
    ...
    public function rules() {
        return array(
            array('product_name, product_category_id, purchase_header_id', 'required'),
            ...
            array('id, product_name, length, width, height, unit_price, quantity, weight, product_category_id, purchase_header_id, work_order_cutting_detail_id, is_inactive, discount_amount', 'safe', 'on' => 'search'),
        );
    }
