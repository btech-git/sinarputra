...
class PurchaseDetailServiceBase extends ActiveRecord {
    ...
    public function rules() {
        return array(
            array('name, purchase_header_id', 'required'),
            ...
            array('amount, discount_amount', 'length', 'max' => 18),
            // The following rule is used by search().
            array('id, name, length_initial, length_final, width_initial, width_final, height_initial, height_final, quantity, weight, amount, purchase_header_id, is_miling, is_grinding, is_hardness, is_annelying, is_sidemiling, is_inactive, discount_amount', 'safe', 'on' => 'search'),
        );
    }
