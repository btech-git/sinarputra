 ...
 * @property integer $is_proceed_to_work_order
 *
...
class SaleDetailBase extends ActiveRecord {
    ...
    public function rules() {
        return array(
            ...
            array('quotation_detail_product_id, quotation_detail_service_id, sale_header_id, is_inactive, is_proceed_to_work_order', 'numerical', 'integerOnly' => true),
            // The following rule is used by search().
            array('id, quotation_detail_product_id, quotation_detail_service_id, sale_header_id, is_inactive, is_proceed_to_work_order', 'safe', 'on' => 'search'),
        );
    }
