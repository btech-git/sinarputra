 ...
 */
class ManualSalePaymentHeaderBase extends MonthlyTransactionActiveRecord {

    public function tableName() {
        return 'tblsp_manual_sale_payment_header';
    }
    ...
    public function rules() {
        return array(
            ...
            array('id, cn_ordinal, cn_month, cn_year, date, date_created, additional_payment_1, additional_payment_2, note, customer_id, account_id_additional_payment_1, account_id_additional_payment_2, admin_id, is_inactive, admin_id_updated, created_datetime, updated_datetime', 'safe', 'on' => 'search'),
        );
    }

    public function relations() {
        return array(
            'manualSalePaymentDetails' => array(self::HAS_MANY, 'ManualSalePaymentDetail', 'manual_sale_payment_header_id'),
