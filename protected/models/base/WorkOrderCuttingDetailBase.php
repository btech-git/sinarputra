 ...
 */
class WorkOrderCuttingDetailBase extends ActiveRecord {

    public function tableName() {
        return 'tblsp_work_order_cutting_detail';
    }

    public function rules() {
        return array(
            array('product_name, job_number, work_order_cutting_header_id, sale_detail_id, product_category_id, employee_id', 'required'),
            array('quantity, quantity_delivery, work_order_cutting_header_id, sale_detail_id, product_category_id, is_miling, is_grinding, is_hardness, is_annelying, is_sidemiling, is_external_order, is_cut, is_urgent, is_delivery, is_inactive, employee_id', 'numerical', 'integerOnly' => true),
            ...
            array('id, product_name, job_number, length_request, width_request, height_request, length_quote, width_quote, height_quote, quantity, quantity_delivery, weight, work_order_cutting_header_id, sale_detail_id, product_category_id, is_miling, is_grinding, is_hardness, is_annelying, is_sidemiling, is_external_order, is_cut, is_urgent, is_delivery, is_inactive, employee_id', 'safe', 'on' => 'search'),
        );
    }

    public function relations() {
        return array(
            'deliveryDetails' => array(self::HAS_MANY, 'DeliveryDetail', 'work_order_cutting_detail_id'),
            'manualDeliveryDetails' => array(self::HAS_MANY, 'ManualDeliveryDetail', 'work_order_cutting_detail_id'),
            'productionPlanningCuttingDetails' => array(self::HAS_MANY, 'ProductionPlanningCuttingDetail', 'work_order_cutting_detail_id'),
            'productionPlanningMilingDetails' => array(self::HAS_MANY, 'ProductionPlanningMilingDetail', 'work_order_cutting_detail_id'),
            'purchaseDetails' => array(self::HAS_MANY, 'PurchaseDetail', 'work_order_cutting_detail_id'),
            'qualityControlCuttingDetails' => array(self::HAS_MANY, 'QualityControlCuttingDetail', 'work_order_cutting_detail_id'),
            'qualityControlMilingDetails' => array(self::HAS_MANY, 'QualityControlMilingDetail', 'work_order_cutting_detail_id'),
            'saleInvoiceDetails' => array(self::HAS_MANY, 'SaleInvoiceDetail', 'work_order_cutting_detail_id'),
            ...
            'workOrderCuttingDetailMaterials' => array(self::HAS_MANY, 'WorkOrderCuttingDetailMaterial', 'work_order_cutting_detail_id'),
            'workOrderReplacementDetails' => array(self::HAS_MANY, 'WorkOrderReplacementDetail', 'work_order_cutting_detail_id'),
            'employee' => array(self::BELONGS_TO, 'Employee', 'employee_id', 'scopes'=>array('resetScope')),
        );
    }
    ...
    public function search() {
        ...
        $criteria->compare('t.quantity_delivery', $this->quantity_delivery);
