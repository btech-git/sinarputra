    ...
    <?php foreach ($model->details as $i => $detail): ?>
        <tr style="background-color: azure">
            <td><!--code-->
                ...
                <?php echo CHtml::encode(CHtml::value($detail, 'workOrderReplacementDetail.job_number')); ?>
            </td>

            <td><!--Product name-->
                <?php echo CHtml::encode(CHtml::value($detail, 'workOrderReplacementDetail.product_name')); ?>
            </td>

            <td style="text-align: center">
                <?php echo CHtml::encode(CHtml::value($detail, 'workOrderReplacementDetail.quantity')); ?>
            </td>
