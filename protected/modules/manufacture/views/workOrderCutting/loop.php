...
<div class="form">
    ...
    <div class="span-12">
        <div class="row">
            ...
            <?php echo CHtml::encode($model->header->getCodeNumber(WorkOrderCuttingHeader::CN_CONSTANT)); ?>
        </div>
    ...
    <table style="border: 1px solid">
        ...
        <tr>
            ...
            <td style="text-align: center;">
                <?php echo CHtml::encode(CHtml::value($model->details[$index], 'height_quote')); ?>
            </td>
            <td style="text-align: center;">
                <?php echo CHtml::encode(CHtml::value($model->details[$index], 'width_quote')); ?>
            </td>
            <td style="text-align: center;">
                <?php echo CHtml::encode(CHtml::value($model->details[$index], 'length_quote')); ?>
            </td>
            <td style="text-align: center;">
            ...
            <td style="text-align: center;">
                <?php echo CHtml::encode(CHtml::value($model->details[$index], 'weight')); ?>
            </td>
            <td style="text-align: center;">
                <?php echo CHtml::encode(CHtml::value($model->details[$index], 'deliveryStatus')); ?>
            </td>
            <td style="text-align: center;">
    ...
    <?php if ((int)$model->details[$index]->is_cut === 1 && (int)$model->details[$index]->is_external_order === 0): ?>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns' => array(
        ...
        array(
            'header' => 'Kategori',
            'filter' => CHtml::activeDropDownList($receiveDetail, 'product_category_id', CHtml::listData(ProductCategory::model()->findAll(array('order' => 'name ASC')), 'id', 'name'), array(
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns' => array(
        ...
        array(
            'header' => 'Kategori',
            'filter' => CHtml::activeDropDownList($workOrderCuttingDetailMaterial, 'product_category_id', CHtml::listData(ProductCategory::model()->findAll(array('order' => 'name ASC')), 'id', 'name'), array(
                'empty' => '-Select Kategori-'
            )),
            'value' => 'CHtml::value($data, "productCategory.name")'
        ),
