...
<!--        <div class="form-row">
            <div class="form-group">
                <?php /*echo $form->labelEx($model->header, 'Warga Negara'); ?>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <?php echo $form->dropDownList($model->header, 'is_female', array(
            ...
            <div class="form-group">
                ...
                <?php echo $form->dropDownList($model->header, 'marital_status', array(
    ...
    <fieldset>
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                <?php echo $form->labelEx($model->header, 'Hubungan Keluarga'); ?>
                <?php echo $form->dropDownList($model->header, 'family_status', array(
        ...
        <div class="form-row">
            <div class="form-group">
                <?php echo $form->labelEx($model->header, 'K T P #'); ?>
            ...
            <div class="form-group">
                <?php echo $form->labelEx($model->header, 'Tanggal K T P Expired'); ?>
                <?php $this->widget('zii.widgets.jui.CJuiDatePicker', array(
                    'model' => $model->header,
        ...
        <div class="form-row">
            <div class="form-group">
                <?php echo $form->labelEx($model->header, 'S I M #'); ?>
            ...
            <div class="form-group">
                <?php echo $form->labelEx($model->header, 'Tanggal S I M expired'); ?>
                <?php $this->widget('zii.widgets.jui.CJuiDatePicker', array(
                    'model' => $model->header,
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                <?php echo $form->labelEx($model->header, 'N I K Keluarga'); ?>
    ...
    <fieldset>
        ...
        <div class="form-row">
            <div class="form-group">
                <?php echo $form->labelEx($model->header, 'B P J S Kesehatan'); ?>
            ...
            <div class="form-group">
                <?php echo $form->labelEx($model->header, 'B P J S Ketenagakerjaan'); ?>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <?php echo $form->dropDownList($model->header, 'cost_center', array(
            ...
            <div class="form-group">
                ...
                <?php echo $form->dropDownList($model->header, 'tax_status', array(
        ...
        <div class="form-row">
            <div class="form-group">
                <?php echo $form->labelEx($model->header, 'N P W P #'); ?>
    ...
    <div class="form-group">
        <?php echo CHtml::button('Add Family Relationship', array(
            'id' => 'size_button',
            'onclick' => '
                $.ajax({
                    type: "POST",
    ...
    <div class="form-group">
        <?php echo CHtml::button('Add Formal Education', array(
            'id' => 'size_button',
            'onclick' => '
                $.ajax({
                    type: "POST",
    ...
    <div class="form-group">
        <?php echo CHtml::button('Add Job Experience', array(
            'id' => 'size_button',
            'onclick' => '
                $.ajax({
                    type: "POST",
    ...
    <?php if ($model->header->isNewRecord): ?>
        <div class="formLabel"><?php echo CHtml::label('Foto Employee: ', FALSE); ?></div>
        ...
        <div class="form-group">
            ...
            <?php echo $form->dropDownList($model->header, 'is_inactive', array(
