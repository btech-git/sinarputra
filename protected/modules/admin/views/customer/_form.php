    ...
    <fieldset>
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <?php echo $form->dropDownList($model, 'employee_id', CHtml::listData(Employee::model()->findAll(array(
                    'condition' => 'department_id = 2', 
                    'order' => 'name ASC'
                )), 'id', 'name'), array('empty' => '-Select Employee-')); ?>
        ...
        <div class="form-row">
            <div class="form-group">
                <?php echo $form->labelEx($model, 'Nama NPWP'); ?>
        ...
        <div class="form-row">
            <div class="form-group">
                <?php echo $form->labelEx($model, 'Jatuh Tempo (hari)'); ?>
