...
class PurchaseItemController extends Controller {
	...
	$purchaseItem->header->is_tax = 1;
        ...
        $purchaseItem->header->created_datetime = date('Y-m-d H:i:s');
    ...
    public function actionUpdate($id) {
        ...
        $purchaseItem->header->admin_id_updated = Yii::app()->user->id;
        $purchaseItem->header->updated_datetime = date('Y-m-d H:i:s');
