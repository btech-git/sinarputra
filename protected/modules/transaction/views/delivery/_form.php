<div class="form">
    ...
    <div class="container">
        <div class="span-12">
            ...
            <div class="row">
                <?php echo CHtml::label('Sample ?', ''); ?>
                <?php echo CHtml::activeCheckBox($delivery->header, 'is_sample'); ?>
                <?php echo CHtml::error($delivery->header, 'is_sample'); ?>
            </div>

            <div class="row">
                <?php echo CHtml::label('Catatan', ''); ?>
                <?php echo CHtml::activeTextArea($delivery->header, 'note', array('rows' => 5, 'cols' => 30, 'class' => 'TabOnEnter',
                    'tabindex' => '1')); ?>
            ...
            <?php if (!$delivery->header->isNewRecord) : ?>
                <div class="row">
                    <?php echo CHtml::label('SJ Terkirim?', ''); ?>
                    <?php echo CHtml::activeCheckBox($delivery->header, 'is_delivered'); ?>
                    <?php echo CHtml::error($delivery->header, 'is_delivered'); ?>
                </div>
        ...
        <div class="span-12 last">
            ...
            <div class="row">
                <?php echo CHtml::label('Remark C3 / Sales Order', ''); ?>
                <?php echo CHtml::encode(CHtml::value($delivery->header, 'workOrderCuttingHeader.saleHeader.note')); ?>
            </div>

            <div class="row">
                <?php echo CHtml::label('Butuh BTB?', ''); ?>
                <?php echo CHtml::activeDropDownList($delivery->header,'is_delivery_approval_needed', array(
                    0 => 'Tidak', 
                    1 => 'Perlu', 
                    2 => 'Sudah',
                )); ?>
                <?php echo CHtml::error($delivery->header, 'is_delivery_approval_needed'); ?>
            </div>
        </div>
    </div>
