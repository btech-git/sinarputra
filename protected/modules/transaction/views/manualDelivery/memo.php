...
<table width="100%">
    ...
    <tr>
        ...
        <td>:</td>
        <td style="border-right: 2px solid;">
            <?php echo CHtml::encode($delivery->getCodeNumber(ManualDeliveryHeader::CN_CONSTANT)); ?>
        </td>
    </tr>
    <tr>
...
<table class="memo">
    ...
    <?php $nomor = 1; ?>
    <?php foreach ($delivery->manualDeliveryDetails as $i => $detail): ?>
        <tr class="titems">
    ...
    <tr class="titems">
        ...
        <td style="border-top: 2px solid #555; text-align: center; font-weight: bold;">
            <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', $delivery->getTotalQuantity())); ?>
        </td>
        <td style="border-top: 2px solid #555"></td>
        <td style="border-top: 2px solid #555; text-align: center; font-weight: bold;">
            <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', $delivery->getTotalWeight())); ?>
        </td>
    </tr>
</table>
