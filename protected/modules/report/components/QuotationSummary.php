...
class QuotationSummary extends CComponent {
...
//            'quotationDetailServices:resetScope',
//            'quotationDetailProducts:resetScope'
        );
    }
...
//        $this->dataProvider->criteria->compare('t.is_confirmed', $filters['status']);
    }
