...
class ProductionPlanningReplacementMilingSummary extends CComponent {
    ...
    public function setupLoading() {
        ...
        $this->dataProvider->criteria->condition = 't.work_order_replacement_header_id IS NOT NULL';
    }
    ...
    public function setupSorting() {
        $this->dataProvider->sort->attributes = array('t.date', 'saleHeader.customer_id', 't.cn_ordinal');
