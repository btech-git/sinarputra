...
<div class="hide">
    <div class="form" style="text-align: center">
        ...
        <div class="row">
            ...
            || Barang / Jasa
            <?php /*echo CHtml::activeDropDownList($workOrderCuttingDetail, 'workOrderCuttingHeader.is_service', array(
                WorkOrderCuttingHeader::PRODUCT => WorkOrderCuttingHeader::PRODUCT_LITERAL,
                WorkOrderCuttingHeader::SERVICE => WorkOrderCuttingHeader::SERVICE_LITERAL
            ), array('empty' => '-- Semua SO --'));*/ ?>
        </div>
    ...
    <div class="clear"></div>
    <div class="right"><?php echo ReportHelper::sortText($workOrderSummary->dataProvider->sort, array('Tanggal', 'Customer')); ?></div>
    <div class="clear"></div>
</div>

<div>
    <?php $this->renderPartial('_summary', array('workOrderSummary' => $workOrderSummary, 'startDate' => $startDate, 'endDate' => $endDate)); ?>
</div>
