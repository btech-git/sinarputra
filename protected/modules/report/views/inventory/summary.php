...
<div class="hide">
    <div class="form" style="text-align: center">
        ...
        <div class="row">
            Customer
            <?php echo CHtml::activeDropDownlist($inventory, 'customer_id', CHtml::listData(Customer::model()->findAll(array('order' => 'company ASC')), 'id', 'company'), array('empty' => '-- Semua Customer --')); ?>
        </div>
    ...
    <div class="clear"></div>
    <div class="right"><?php echo ReportHelper::sortText($inventorySummary->dataProvider->sort, array('Tanggal', 'Customer')); ?></div>
    <div class="clear"></div>
</div>

<div>
    <?php $this->renderPartial('_summary', array('inventorySummary' => $inventorySummary, 'startDate' => $startDate, 'endDate' => $endDate)); ?>
</div>
