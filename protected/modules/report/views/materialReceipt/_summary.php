...
<div style="font-weight: bold; text-align: center">
    ...
    <div style="font-size: larger">Laporan Tanda Terima Penjualan Manual 2</div>
...
<table class="report">
    ...
    <?php foreach ($saleReceiptDetailSummary->dataProvider->data as $header): ?>
        <tr>
            <?php 
                $saleReceiptHeader = empty($header->materialReceiptHeader) ? '' : $header->materialReceiptHeader;
                $saleInvoiceHeader = $header->materialInvoiceHeader;
            ?>
            <td class="width1-1"><?php echo CHtml::encode($saleReceiptHeader->getCodeNumber(MaterialReceiptHeader::CN_CONSTANT)); ?></td>
            ...
            <td class="width1-7"><?php echo CHtml::encode($saleInvoiceHeader->getCodeNumber(MaterialInvoiceHeader::CN_CONSTANT)); ?></td>
