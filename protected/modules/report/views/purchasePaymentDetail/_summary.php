...
<div style="font-weight: bold; text-align: center">
    ...
    <div style="font-size: larger">Laporan Pelunasan Pembelian</div>
...
<table class="report">
    <tr id="header1">
        ...
        <th class="width1-3" style="text-align: left;border-bottom: 2px solid;">Supplier</th>
        <th class="width1-4" style="text-align: left;border-bottom: 2px solid;">TT #</th>
    ...
    <?php foreach ($purchasePaymentSummary->dataProvider->data as $header): ?>
        <?php foreach ($header->purchasePaymentDetails as $detail): ?>
            <tr>
                ...
                <td class="width1-3"><?php echo CHtml::encode(CHtml::value($header, 'purchaseReceiptHeader.supplier.company')); ?></td>
                <td class="width1-4"><?php echo CHtml::encode($header->purchaseReceiptHeader->getCodeNumber(PurchaseReceiptHeader::CN_CONSTANT));?></td>
