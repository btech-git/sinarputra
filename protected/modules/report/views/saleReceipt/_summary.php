...
<table class="report">
    ...
    <?php foreach ($saleReceiptDetailSummary->dataProvider->data as $header): ?>
        <tr>
            <?php 
                $saleReceiptHeader = empty($header->saleReceiptHeader) ? '' : $header->saleReceiptHeader;
                $saleInvoiceHeader = $header->saleInvoiceHeader;
            ?>
            <td class="width1-1"><?php echo CHtml::encode($saleReceiptHeader->getCodeNumber(SaleReceiptHeader::CN_CONSTANT)); ?></td>
            ...
            <td class="width1-7"><?php echo CHtml::encode($saleInvoiceHeader->getCodeNumber(SaleInvoiceHeader::CN_CONSTANT)); ?></td>
