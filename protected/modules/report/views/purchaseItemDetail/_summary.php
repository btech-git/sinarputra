...
<table class="report">
    <tr id="header1">
        ...
        <th class="width1-8" style="border-bottom: 2px solid;">Disc</th>
    ...
    <?php endforeach; ?>
    <tr>
        <th colspan="9" style="text-align: right; border-top: 2px solid">TOTAL</th>
        <th class="width1-9" style="text-align: right; border-top: 2px solid">
            <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', $this->reportGrandTotal($purchaseItemDetailSummary->dataProvider))); ?>
        </th>
    </tr>
</table>