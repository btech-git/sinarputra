...
class ManualSalePaymentController extends Controller {
    ...
    public function actionCreate() {
        ...
        $salePayment->header->date_created = date('Y-m-d H:i:s');
        ...
        $customerId = isset($_GET['ManualSalePaymentHeader']['customer_id']) ? $_GET['ManualSalePaymentHeader']['customer_id'] : '';

        if (!empty($customerId)) {
            $saleInvoiceDataProvider->criteria->addCondition("customer_id = :customer_id");
    ...
    public function actionUpdate($id) {
        ...
        $customerId = $salePayment->header->customer_id;
    ...
    public function actionAjaxJsonCustomer($id) {
        if (Yii::app()->request->isAjaxRequest) {
            $customerId = (isset($_POST['ManualSalePaymentHeader']['customer_id'])) ? $_POST['ManualSalePaymentHeader']['customer_id'] : '';
