...
class ExpenseController extends Controller {
    ...
    public function actionCreate() {
        ...
        $expense->header->created_datetime = date('Y-m-d H:i:s');
    ...
    public function actionUpdate($id) {
        ...
        $expense->header->admin_id_updated = Yii::app()->user->id;
        $expense->header->updated_datetime = date('Y-m-d H:i:s');
