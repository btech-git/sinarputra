...
class ManualSaleReceipt extends CComponent {
    ...
    public function generateCodeNumber($currentMonth, $currentYear) {
        $saleReceiptHeader = ManualSaleReceiptHeader::model()->find(array(
    ...
    public function validate() {
        ...
        if (count($this->details) > 0) {
            foreach ($this->details as $detail) {
                $fields = array('memo', 'manual_sale_invoice_header_id');
    ...
    public function flush() {
        ...
        foreach ($this->details as $detail) {
            if ($detail->isNewRecord)
                $detail->manual_sale_receipt_header_id = $this->header->id;
    ...
    public function getTotalReceipt() {
        ...
        foreach ($this->details as $detail)
            $total += CHtml::value($detail, 'manualSaleInvoiceHeader.grandTotal');
