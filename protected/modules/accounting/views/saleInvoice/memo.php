...
<?php foreach (range(1, $pageNumber) as $num): ?>
    ...
    <div id="memoheader" style="width: 95%">
        <h3>INVOICE NO: <?php echo $saleInvoice->getCodeNumber(SaleInvoiceHeader::CN_CONSTANT); ?></h3>
    </div>
    ...
    <table style="width:97%; padding-left: 20px">
        <tr>
            ...
            <td style="border-top: 2px solid; width:38%;">
                <?php echo CHtml::encode(CHtml::value($saleInvoice, 'workOrderCuttingHeader.saleHeader.customer.company')); ?>
            </td>
        ...
        <tr>
            <td style="border-left: 2px solid; font-size: 10px;" colspan="3">
                <?php echo CHtml::encode(CHtml::value($saleInvoice, 'workOrderCuttingHeader.saleHeader.customer.completeTaxAddress')); ?>
            </td>
            <td style="border-left: 2px solid;">No. PO</td>
            <td>:</td>
        ...
        <tr>
            <td style="border-left: 2px solid" colspan="3">
                Fax <?php echo CHtml::encode(CHtml::value($saleInvoice, 'workOrderCuttingHeader.saleHeader.customer.fax')); ?>
            </td>
    ...
    <table class="memo" style="width:95%; font-size: 12px">
        <tr id="theader">
            ...
            <th style="width: 20%; border-bottom: 2px solid; border-right: 2px solid;">Jumlah (Rp)</th>
        </tr>
		<?php $counter = 0; ?>
