...
<?php $this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns' => array(
        ...
        array(
            ...
            'value' => 'empty($data->customer_id) ? "" : $data->customer->company',
        ),
        array(
            'header' => 'Total',
            'filter' => false,
        ...
        array(
            ...
            'value' => 'empty($data->work_order_cutting_header_id) ? "" : $data->workOrderCuttingHeader->saleHeader->customer_order_number',
        ),
        array(
            'header' => 'F. Pajak',
            'name' => 'tax_number',
