<table style="border: 1px solid">
    ...
    <?php foreach ($saleReceipt->details as $i => $detail): ?>
        <?php $tabIndex = $i * 2; ?>
        <?php $detailSaleInvoice = $detail->saleInvoiceHeader(array('scopes' => 'resetScope')); ?>

        <tr style="background-color: azure">
            <td style="text-align: center">
                <?php echo CHtml::activeHiddenField($detail, "[$i]sale_invoice_header_id"); ?>
                <?php echo CHtml::encode($detailSaleInvoice->getCodeNumber(SaleInvoiceHeader::CN_CONSTANT)); ?>
            </td>
            <td style="text-align: center">
