<table style="border: 1px solid">
    ...
    <?php foreach ($saleInvoice->details as $i => $detail): ?>	
        <?php $workOrderCuttingDetail = WorkOrderCuttingDetail::model()->findByPk($detail->deliveryDetail->work_order_cutting_detail_id); ?>
        <tr style="background-color: azure;">
            <td style="text-align:center;">
                <?php echo CHtml::activeHiddenField($detail, "[$i]delivery_detail_id"); ?>
                <?php echo CHtml::encode($detail->deliveryDetail->workOrderCuttingDetail->workOrderCuttingHeader->getCodeNumber(WorkOrderCuttingHeader::CN_CONSTANT)); ?>
            </td>
            <td style="text-align:center;">
                <?php echo CHtml::encode($detail->deliveryDetail->deliveryHeader->getCodeNumber(DeliveryHeader::CN_CONSTANT)); ?>
            </td>
            <td style="text-align:center;">
                <?php echo CHtml::encode(Yii::app()->dateFormatter->format("d MMM yyyy", $detail->deliveryDetail->deliveryHeader->date)); ?>
            </td>
            <td style="text-align:center;">
            ...
            <td style="text-align: center;">
                <?php echo CHtml::activeTextField($detail, "[$i]weight", array('size' => 3, 'maxLength' => 10,
            ...
            <td style="text-align: right;">
                <?php echo CHtml::activeTextField($detail, "[$i]unit_price", array('size' => 5, 'maxLength' => 18,
                    'onchange' => CHtml::ajax(array(
                        'type' => 'POST',
                        'dataType' => 'JSON',
                        'url' => CController::createUrl('ajaxJsonTotal', array('id' => $saleInvoice->header->id, 'index' => $i)),
    ...
    <tr style="background-color: aquamarine;">
        ...
        <td style="font-weight: bold; text-align: right;">
            <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', CHtml::value($saleInvoice, 'totalQuantity'))); ?>
        </td>
    ...
    <tr style="background-color: aquamarine;">
        <td style="font-weight: bold; text-align: right;" colspan="13">Discount</td>
        <td style="font-weight: bold; text-align: right;">
    ...
    <tr style="background-color: aquamarine;">
        <td style="font-weight: bold; text-align: right;" colspan="13">
            PPn <?php echo CHtml::activeTextField($saleInvoice->header, "tax_percentage"); ?>%
        </td>
        <td style="font-weight: bold; text-align: right;">
            <span id="tax_value">
    ...
    <tr style="background-color: aquamarine;">
        <td style="font-weight: bold; text-align: right;" colspan="13">PPh 2% &nbsp;
    ...
    <tr style="background-color: aquamarine;">
        <td style="font-weight: bold; text-align: right;" colspan="13">Grand Total</td>
        <td style="font-weight: bold; text-align: right;">
            <span id="grand_total">
