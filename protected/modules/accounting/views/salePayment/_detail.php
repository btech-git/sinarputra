<table style="border: 1px solid">
    ...
    <?php foreach ($salePayment->details as $i => $detail): ?>
        ...
        <tr style="background-color: azure">
            <td>
                ...
                <?php echo CHtml::encode($detail->saleInvoiceHeader->getCodeNumber(SaleInvoiceHeader::CN_CONSTANT)); ?>
                <?php echo CHtml::error($detail, 'sale_invoice_header_id'); ?>
            </td>
            <td>
    ...
    <tr style="background-color: aquamarine">
        ...
        <td style="text-align: right; font-weight: bold">
            <span id="receivable">
                <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', CHtml::value($salePayment->header, 'totalReceivable'))); ?>
            </span>
        </td>
        <td></td>
    </tr>
    <tr style="background-color: aquamarine">
        ...
        <td style="text-align: right;font-weight: bold">
            <span id="payment">
                <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', CHtml::value($salePayment->header, 'payment'))); ?>
            </span>
        </td>
        <td></td>
    </tr>
    <tr style="background-color: aquamarine">
        ...
        <td style="text-align: right; font-weight: bold">
            <span id="additional_payment_1">
                <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', CHtml::value($salePayment->header, 'additional_payment_1'))); ?>
            </span>
        </td>
        <td></td>
    </tr>
    <tr style="background-color: aquamarine"> 
        ...
        <td style="text-align: right; font-weight: bold">
            <span id="additional_payment_2">
                <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', CHtml::value($salePayment->header, 'additional_payment_2'))); ?>
            </span>
        </td>
        <td></td>
    </tr>
    <tr style="background-color: aquamarine">
        ...
        <td style="text-align: right; font-weight: bold">
            <span id="remaining">
                <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', CHtml::value($salePayment->header, 'remaining'))); ?>
            </span>
        </td>
        <td></td>
    </tr>
