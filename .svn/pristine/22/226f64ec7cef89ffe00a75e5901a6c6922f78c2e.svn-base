...
$this->widget('zii.widgets.CDetailView', array(
    ...
    'attributes' => array(
        ...
        array(
            'label' => 'SPK #',
            'value' => $model->workOrderReplacementHeader ? CHtml::encode($model->workOrderReplacementHeader->getCodeNumber(WorkOrderReplacementHeader::CN_CONSTANT)) : 'N/A',
        ),
        array(
            'label' => 'Customer',
            'value' => $model->workOrderReplacementHeader ? CHtml::encode($model->workOrderReplacementHeader->workOrderCuttingHeader->saleHeader->customer->company) : 'N/A',
        ),
        array(
            'label' => 'Catatan',
            'value' => $model->note,
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
    ...
    array(
        array(
            'header' => 'Job Number',
            'value' => 'CHtml::value($data, "workOrderReplacementDetail.job_number")',
        ),
        array(
            'header' => 'Item',
            'value' => 'CHtml::value($data, "workOrderReplacementDetail.product_name")',
        ),
        array(
            'header' => 'Tbl / Dmtr',
