...
$this->breadcrumbs = array(
    'Pengeluaran Kas Bank' => array('create'),
    'Manage',
);
...
Yii::app()->clientScript->registerScript('search', "
	...
	");
?>
<h1>Kelola Pengeluaran Kas / Bank</h1>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns' => array(
        array(
            ...
            '<div style="display: inline-block"> &nbsp; /' . ExpenseHeader::CN_CONSTANT . '/ &nbsp; </div>' .
            ...
            'value' => '$data->getCodeNumber(ExpenseHeader::CN_CONSTANT)',
