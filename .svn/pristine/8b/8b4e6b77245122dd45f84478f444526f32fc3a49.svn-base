...
class PurchaseController extends Controller {
    ...
    public function actionCreate() {
        ...
        $purchase->header->created_datetime = date('Y-m-d H:i:s');
    ...
    public function actionUpdate($id) {
        ...
        $purchase->header->admin_id_updated = Yii::app()->user->id;
        $purchase->header->updated_datetime = date('Y-m-d H:i:s');
