...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'dataProvider'=>new CArrayDataProvider($salePayment->salePaymentDetails),
	'columns'=>array(
		array(
			'header'=>'Invoice #',
...
<table style="background-color: greenyellow">
    <tr>
        ...
        <td style="width: 20%; text-align: right; font-weight: bold">
            <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', CHtml::value($salePayment, 'payment'))); ?>
        </td>
    </tr>
    <tr>
