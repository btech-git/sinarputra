...
<div style="font-weight: bold; text-align: center">
    ...
    <div style="font-size: larger">Laporan SPK Replacement Detail</div>
...
<table class="report">
    <tr id="header1">
        <th style="text-align: center" colspan="14">Permintaan</th>
        <th style="text-align: center" colspan="8">Penawaran</th>
    </tr>
    <tr id="header2">
        ...
        <th class="width2-13" style="text-align: left;border-bottom: 2px solid;">Plan Finish</th>
        <th class="width2-14" style="text-align: left;border-bottom: 2px solid;">Plan SLA</th>
    </tr>
    ...
    <?php foreach ($workOrderReplacementSummary->dataProvider->data as $header): ?>
        <?php foreach ($header->workOrderReplacementDetails as $detail): ?>
            <tr>
                ...
                <td class="width2-2" style="text-align: left"><?php echo CHtml::encode($header->getCodeNumber(WorkOrderReplacementHeader::CN_CONSTANT)); ?></td>
                <td class="width2-3" style="text-align: left"><?php echo CHtml::encode(CHtml::value($header, 'workOrderCuttingHeader.saleHeader.customer.company')); ?></td>
                <td class="width2-4" ><?php echo CHtml::encode(CHtml::value($detail, 'workOrderCuttingDetail.saleDetail.quotationDetailProduct.product_name_quote')); ?></td>
                <td class="width2-5" ><?php echo CHtml::encode(CHtml::value($detail, 'workOrderCuttingDetail.saleDetail.quotationDetailProduct.productCategory.name')); ?></td>
                ...
                <td class="width2-10" style="text-align: right">
                    <?php echo CHtml::encode($detail->weightRequest); ?>
                </td>
                <td class="width2-11" style="text-align: left"><?php echo CHtml::encode(CHtml::value($header, 'workOrderCuttingHeader.saleHeader.customer_order_number')); ?></td>
                <td class="width2-12" style="text-align: left; ">
                    <?php echo CHtml::encode((CHtml::value($detail, 'is_cut') == 1) ? "C" : ""); ?>
                    <?php echo CHtml::encode((CHtml::value($detail, 'workOrderCuttingDetail.saleDetail.quotationDetailProduct.is_miling') == 1) ? "M" : ""); ?>
                    <?php echo CHtml::encode((CHtml::value($detail, 'workOrderCuttingDetail.saleDetail.quotationDetailProduct.is_grinding') == 1) ? "G" : ""); ?>
                    <?php echo CHtml::encode((CHtml::value($detail, 'workOrderCuttingDetail.saleDetail.quotationDetailProduct.is_hardness') == 1) ? "FH" : ""); ?>
                    <?php echo CHtml::encode((CHtml::value($detail, 'workOrderCuttingDetail.saleDetail.quotationDetailProduct.is_annelying') == 1) ? "ANNL" : ""); ?>
                    <?php echo CHtml::encode((CHtml::value($detail, 'workOrderCuttingDetail.saleDetail.quotationDetailProduct.is_sidemiling') == 1) ? "SM" : ""); ?>
                </td>
