...
<h1>Update Surat Perintah Kerja (SPK)</h1>
<?php
...
<div class="form">
    ...
    <div class="container">
        <div class="span-12">
            <div class="row">
                ...
                <span id="sale_header_number_span_cn">
                    <?php echo isset($model->saleHeader) ? CHtml::encode($model->saleHeader->getCodeNumber(SaleHeader::CN_CONSTANT)) : ''; ?>
                </span>
            </div>
        ...
        <div class="span-12 last">
            ...
            <div class="row">
                ...
                <?php echo CHtml::encode(Yii::app()->dateFormatter->format('d-MMMM-yyyy', CHtml::value($model, 'saleHeader.date'))); ?>
            </div>
            ...
            <div class="row">
                ...
                <?php echo CHtml::activeCheckBox($model, 'is_pending'); ?>
            </div>
            <div class="row">
    ...
    <div id="detail_product_div">
        <h2>Sales Order <?php echo ((int)$model->saleHeader->is_service == 1) ? 'Jasa': 'Barang'; ?></h2>
        <table style="border: 1px solid">
            <tr style="background-color: skyblue">
                ...
                <th colspan=<?php echo ((int)$model->saleHeader->is_service == 1) ? "12" : "11";?>>&nbsp;</th>
            </tr>
            ...
            <tr style="background-color: skyblue">
                ...
                <?php if ((int)$model->saleHeader->is_service == 1): ?>
                    <th style="text-align: center; width: 5%">Cut</th>
                <?php endif; ?>
            </tr>

            <?php foreach ($model->workOrderCuttingDetails as $i => $detail): ?>
                <tr>
    ...
    <div class="row buttons">
        <?php echo CHtml::submitButton('Submit', array('name' => 'Submit', 'confirm' => 'Are you sure you want to next?')); ?>
