...
/**
 * @property integer $id
 * @property string $product_name_request
 * @property string $product_name_quote
 ...
 */
class QuotationDetailProductBase extends ActiveRecord {

    public function tableName() {
        return 'tblsp_quotation_detail_product';
    }

    public function rules() {
        return array(
            array('product_name_request, job_number, product_category_id, quotation_header_id', 'required'),
            array('quantity_request, quantity_quote, product_category_id, quotation_header_id, is_miling, is_grinding, is_hardness, is_coating, is_annelying, is_sidemiling, is_using_weight, is_inactive', 'numerical', 'integerOnly' => true),
            array('product_name_request, product_name_quote, job_number', 'length', 'max' => 60),
            ...
            array('id, product_name_request, product_name_quote, length_request, length_quote, width_request, width_quote, height_request, height_quote, quantity_request, quantity_quote, weight, unit_price, job_number, product_category_id, quotation_header_id, is_miling, is_grinding, is_hardness, is_annelying, is_sidemiling, is_coating, is_using_weight, is_inactive', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations() {
        return array(
            ...
            'saleDetails' => array(self::HAS_MANY, 'SaleDetail', 'quotation_detail_product_id'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
            'id' => 'ID',
            'product_name_request' => 'Product Name Request',
            'product_name_quote' => 'Product Name Quote',
