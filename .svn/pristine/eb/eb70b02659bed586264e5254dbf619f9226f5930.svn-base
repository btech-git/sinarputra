...
//        $valid = $this->validateDetailsUnique() && $valid;
    ...
    public function flush() {
        ...
        $qualityControlHeader = empty($this->header->quality_control_cutting_header_id) ? $this->header->qualityControlMilingHeader : $this->header->qualityControlCuttingHeader;
