...
<div class="hide">
    ...
    <div class="right"><?php echo ReportHelper::summaryText($receivableLedgerSummary->dataProvider); ?></div>
    <div class="clear"></div>
</div>
...
<div class="hide">
    <div class="right">
        ...
        $this->widget('system.web.widgets.pagers.CLinkPager', array(
            'itemCount' => $receivableLedgerSummary->dataProvider->pagination->itemCount,
            'pageSize' => $receivableLedgerSummary->dataProvider->pagination->pageSize,
            'currentPage' => $receivableLedgerSummary->dataProvider->pagination->getCurrentPage(false),
        ));
        ?>
    </div>
    <div class="clear"></div>
