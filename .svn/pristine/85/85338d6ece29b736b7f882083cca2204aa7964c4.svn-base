...
<div id="memoheader">
    ...
    <div class="memo-title">
        ...
        <div style="font-size: 1.5em">TANDA TERIMA PENJUALAN</div>
    </div>
    <div class="clear"></div>
    ...
    <?php foreach ($saleReceipt->saleReceiptDetails as $i => $detail): ?>
        <tr class="titems">
            ...
            <td style="border-bottom: 1px solid;">
                <?php echo CHtml::encode($detail->saleInvoiceHeader(array("scope" => "resetScope"))->getCodeNumber(SaleInvoiceHeader::CN_CONSTANT)); ?>
            </td>
            <td style="border-bottom: 1px solid;">
                <?php echo CHtml::encode(Yii::app()->dateFormatter->format('d MMMM yyyy', strtotime(CHtml::value($detail, 'saleInvoiceHeader.date')))); ?>
            </td>
            <td style="text-align: right;border-bottom: 1px solid;">
                <?php echo CHtml::encode(CHtml::value($detail, 'saleInvoiceHeader.tax_number')); ?>
            </td>
            <td style="text-align: right;border-bottom: 1px solid;">
                <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', CHtml::value($detail, 'saleInvoiceHeader.grandTotal'))); ?>
            </td>
            <td style="text-align: right;border-bottom: 1px solid;">
