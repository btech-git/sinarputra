...
//			'access',
    ...
    public function actionCreate() {
        ...
        $purchaseReturn->header->created_datetime = date('Y-m-d H:i:s');
    ...
    public function actionUpdate($id) {
        ...
        $purchaseReturn->header->admin_id_updated = Yii::app()->user->id;
        $purchaseReturn->header->updated_datetime = date('Y-m-d H:i:s');
