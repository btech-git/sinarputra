<div class="form">
    ...
    <div class="container">
        <div class="span-12">
            ...
            <div class="row">
                <?php echo CHtml::label('Pemasukan #', false); ?>
                <?php echo CHtml::encode($deposit->header->getCodeNumber(DepositHeader::CN_CONSTANT)); ?>
            </div>
            <?php endif; ?>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
    ...
    'selectionChanged' => 'js:function(id) {
			...
			$.ajax({
				type: "POST",
				url: "' . CController::createUrl('AjaxHtmlAddDetail', array('id' => $deposit->header->id)) . '",
				data: $("form").serialize(),
