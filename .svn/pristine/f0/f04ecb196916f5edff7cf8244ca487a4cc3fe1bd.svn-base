...
<?php $this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns' => array(
        ...
        array(
            'header' => 'QC Cutting #',
            'filter' => false,
            'value' => 'empty($data->workOrderCuttingHeaders) ? "N/A" : $data->workOrderCuttingHeaders[0]->getQualityControlCuttingNumbers()',
            'htmlOptions' => array('style' => 'width: 300px'),
        ),
        array(
            'header' => 'SJ Cutting #',
            'filter' => false,
            'value' => 'empty($data->workOrderCuttingHeaders) ? "N/A" : $data->workOrderCuttingHeaders[0]->getDeliveryCuttingNumbers()',
            'htmlOptions' => array('style' => 'width: 300px'),
        ),
    ),
)); ?>
