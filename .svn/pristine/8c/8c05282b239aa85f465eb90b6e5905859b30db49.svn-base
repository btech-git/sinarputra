...
<div id="memoheader">
    ...
    <div class="memo-title">
        ...
        <div style="font-size: 1.5em">TANDA TERIMA PENJUALAN MANUAL</div>
    </div>
    <div class="clear"></div>
        ...
        <div class="divtablecell hcolumn1">
            <div class="divtable">
                <div class="divtablerow">
                    ...
                    <div class="divtablecell info hcolumn1value"><?php echo CHtml::encode($saleReceipt->getCodeNumber(ManualSaleReceiptHeader::CN_CONSTANT)); ?></div>
                </div>
                <div class="divtablerow">
        ...
        <div class="divtablecell hcolumn2">
            <div class="divtable">
                <div class="divtablerow">
                    ...
                    <div class="divtablecell info hcolumn2value"><?php echo CHtml::encode(CHtml::value($saleReceipt, 'customer.company')); ?></div>
                </div>
                <div class="divtablerow">
...
<table class="memo">
    ...
    <?php $number = 1; ?>
    <?php foreach ($saleReceipt->manualSaleReceiptDetails as $i => $detail): ?>
        <tr class="titems">
            ...
            <td style="border-bottom: 1px solid;">
                <?php echo CHtml::encode(Yii::app()->dateFormatter->format('d MMMM yyyy', strtotime(CHtml::value($detail, 'manualSaleInvoiceHeader.date')))); ?>
            </td>
            <td style="text-align: right;border-bottom: 1px solid;">
                <?php echo CHtml::encode(CHtml::value($detail, 'manualSaleInvoiceHeader.tax_number')); ?>
            </td>
            <td style="text-align: right;border-bottom: 1px solid;">
                <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', CHtml::value($detail, 'manualSaleInvoiceHeader.grandTotal'))); ?>
            </td>
            <td style="text-align: right;border-bottom: 1px solid;">
    ...
    <tr>
        ...
        <td style="border-top: 2px solid; text-align: right">
            <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', floor(CHtml::value($saleReceipt, 'totalReceipt')))); ?>
        </td>
...
<div style="text-transform: capitalize">
    Terbilang:
    <?php echo CHtml::encode(NumberWord::numberName(floor(CHtml::value($saleReceipt, 'totalReceipt')))); ?>
    rupiah
</div>
...
<div>
    CATATAN: <?php echo CHtml::encode(CHtml::value($saleReceipt, 'note')); ?>
</div>
        ...
        <div class="divtablecell sig1">
            ...
            <div style="width: 30%; margin-left: auto; margin-right: auto;">
                <div style="float: center;">
                    <?php echo CHtml::encode(CHtml::value($saleReceipt, 'customer.company')); ?>
                </div>
            </div>
        </div>
