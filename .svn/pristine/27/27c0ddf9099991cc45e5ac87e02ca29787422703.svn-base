<div class="form">
    ...
    <div class="row">
        ...
        <?php echo $form->dropDownList($model, 'account_category_id', CHtml::listData(AccountCategory::model()->findAll(), 'id', 'name')); ?>
    ...
    <div class="row">
        ...
        <?php
        echo $form->dropDownList($model, 'is_inactive', array(
