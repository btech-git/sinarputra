        ...
        foreach ($workOrderCuttingSummary->dataProvider->data as $header) {
            ...
            if ($header->saleHeader->is_service == 1) :
                foreach ($header->workOrderCuttingDetails as $service) {
                    ...
                    $worksheet->setCellValue("F{$counter}", CHtml::encode((CHtml::value($service, 'saleDetail.quotationDetailService.is_miling') == 1) ? "Yes" : "No"));
                    $worksheet->setCellValue("G{$counter}", CHtml::encode((CHtml::value($service, 'saleDetail.quotationDetailService.is_grinding') == 1) ? "Yes" : "No"));
                    $worksheet->setCellValue("H{$counter}", CHtml::encode((CHtml::value($service, 'saleDetail.quotationDetailService.is_hardness') == 1) ? "Yes" : "No"));
                    $worksheet->setCellValue("I{$counter}", CHtml::encode((CHtml::value($service, 'saleDetail.quotationDetailService.is_annelying') == 1) ? "Yes" : "No"));
                    $worksheet->setCellValue("J{$counter}", CHtml::encode((CHtml::value($service, 'saleDetail.quotationDetailService.is_sidemiling') == 1) ? "Yes" : "No"));
                ...
                foreach ($header->workOrderCuttingDetails as $detail) {
                    ...
                    $worksheet->setCellValue("F{$counter}", CHtml::encode((CHtml::value($detail, 'saleDetail.quotationDetailProduct.is_miling') == 1) ? "Yes" : "No"));
                    $worksheet->setCellValue("G{$counter}", CHtml::encode((CHtml::value($detail, 'saleDetail.quotationDetailProduct.is_grinding') == 1) ? "Yes" : "No"));
                    $worksheet->setCellValue("H{$counter}", CHtml::encode((CHtml::value($detail, 'saleDetail.quotationDetailProduct.is_hardness') == 1) ? "Yes" : "No"));
                    $worksheet->setCellValue("I{$counter}", CHtml::encode((CHtml::value($detail, 'saleDetail.quotationDetailProduct.is_annelying') == 1) ? "Yes" : "No"));
                    $worksheet->setCellValue("J{$counter}", CHtml::encode((CHtml::value($detail, 'saleDetail.quotationDetailProduct.is_sidemiling') == 1) ? "Yes" : "No"));
