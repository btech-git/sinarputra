...
<div id="memoheader">
    ...
    <div style="font-size: larger">Jurnal Penerimaan</div>
</div>
        ...
        <div class="divtablecell hcolumn1">
            <div class="divtable">
                <div class="divtablerow">
                    ...
                    <div class="divtablecell info hcolumn1value"><?php echo CHtml::encode($deposit->getCodeNumber(DepositHeader::CN_CONSTANT)); ?></div>
                </div>
                <div class="divtablerow">
        ...
        <div class="divtablecell hcolumn2">
            <div class="divtable">
                <div class="divtablerow">
                    ...
                    <div class="divtablecell info hcolumn1value"><?php echo CHtml::encode(CHtml::value($deposit, 'account.name')); ?></div>
                </div>
            </div>
        </div>
    </div>
...
<table class="memo">
    ...
    <tr>
        ...
        <td style="border-top: 2px solid; font-weight: bold; text-align: right"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', CHtml::value($deposit, 'grandTotal'))); ?></td>
...
<div style="text-transform: capitalize">
    Terbilang:
    <?php echo CHtml::encode(NumberWord::numberName(CHtml::value($deposit, 'grandTotal'))); ?>
    rupiah
</div>
