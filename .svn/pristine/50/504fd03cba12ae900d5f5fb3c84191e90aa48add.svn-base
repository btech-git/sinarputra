...
class EmploymentTypeController extends CrudController {
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['EmploymentType'])) {
            $model->attributes = $_POST['EmploymentType'];
            if ($model->save())
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('EmploymentType');
    ...
    public function actionAdmin() {
        $model = new EmploymentType('search');
        $model->unsetAttributes();
        if (isset($_GET['EmploymentType']))
            $model->attributes = $_GET['EmploymentType'];
    ...
    public function loadModel($id) {
        $model = EmploymentType::model()->findByPk($id);
        if ($model === null)
