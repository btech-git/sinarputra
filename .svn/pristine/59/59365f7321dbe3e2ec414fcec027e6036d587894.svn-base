...
//            '<div style="display: inline-block">' . CHtml::textField('SaleHeaderCnYear', $saleHeaderCnYear, array('maxLength' => 2, 'size' => 2)) . '</div>',
        ...
        array(
            'header' => 'Pending?',
            'name' => 'is_pending',
            'filter' => array(WorkOrderCuttingHeader::NO_VALUE => WorkOrderCuttingHeader::NO_LITERAL, WorkOrderCuttingHeader::YES_VALUE => WorkOrderCuttingHeader::YES_LITERAL),
            'value' => '$data->pending',
        ),
        array(
            'header' => 'Status',
        ...
        array(
            ...
            'updateButtonUrl' => 'CHtml::normalizeUrl(array("updateHeader", "id"=>$data->id))',
        ),
    ),
)); ?>
