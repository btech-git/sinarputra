...
Yii::app()->clientScript->registerCss('_report', '
	...
	.width2-1 { width: 15% }
	.width2-2 { width: 15% }
	.width2-3 { width: 7% ;padding-right: 50px;}
	.width2-4 { width: 5% }
	.width2-5 { width: 15% ; padding-left: 30px;}
	.width2-6 { width: 15% }
	.width2-7 { width: 2% }
	.width2-8 { width: 2%;}
');
...
<div style="font-weight: bold; text-align: center">
    <div style="font-size: larger">Laporan Penerimaan Kas / Bank</div>
...
<table class="report">
    ...
    <?php foreach ($depositSummary->dataProvider->data as $header): ?>
        <tr class="items1">
            <td class="width1-2"><?php echo CHtml::encode(Yii::app()->dateFormatter->format('d MMM yyyy', strtotime($header->date))); ?></td>
            <td class="width1-1"><?php echo CHtml::encode($header->getCodeNumber(DepositHeader::CN_CONSTANT)); ?></td>
        ...
        <td colspan="3" style="border-bottom: 0px solid;">
            <table>
                <tr>
                    ...
                    <th class="width2-4" style="text-align: right"><?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0', ceil($this->reportGrandTotal($depositSummary->dataProvider)))); ?></th>
                    <th class="width2-5" style="text-align: left">&nbsp;</th>
                    <th class="width2-6" style="text-align: left">&nbsp;</th>
                </tr>
            </table>
