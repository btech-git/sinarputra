 ...
 * @property ManualSaleReceiptDetail[] $manualSaleReceiptDetails
 * @property ManualSalePaymentDetail[] $manualSalePaymentDetails
 */
class ManualSaleInvoiceHeaderBase extends MonthlyTransactionActiveRecord {

    public function tableName() {
        return 'tblsp_manual_sale_invoice_header';
    }

    public function rules() {
        return array(
            array('cn_ordinal, cn_month, cn_year, date, due_date, date_created, customer_id, employee_id_salesman, admin_id', 'required'),
            array('cn_ordinal, cn_month, cn_year, service_type, customer_id, employee_id_salesman, work_order_cutting_header_id, admin_id, is_tax, is_tax_income, is_inactive, tax_percentage, admin_id_updated', 'numerical', 'integerOnly' => true),
            array('tax_number, purchase_order_number', 'length', 'max' => 60),
            array('discount, rounding_nominal, grand_total, total_return, total_payment', 'length', 'max' => 18),
            array('date_receipt, note, updated_datetime', 'safe'),
            // The following rule is used by search().
            array('id, cn_ordinal, cn_month, cn_year, date, due_date, date_created, date_receipt, tax_number, note, purchase_order_number, discount, rounding_nominal, grand_total, total_return, total_payment, service_type, work_order_cutting_header_id, customer_id, employee_id_salesman, admin_id, is_tax, is_tax_income, is_inactive, tax_percentage, admin_id_updated, updated_datetime', 'safe', 'on' => 'search'),
        );
    }

    public function relations() {
        return array(
            'manualSaleInvoiceDetails' => array(self::HAS_MANY, 'ManualSaleInvoiceDetail', 'manual_sale_invoice_header_id'),
            ...
            'manualSaleReceiptDetails' => array(self::HAS_MANY, 'ManualSaleReceiptDetail', 'manual_sale_invoice_header_id'),
            'manualSalePaymentDetails' => array(self::HAS_MANY, 'ManualSalePaymentDetail', 'manual_sale_invoice_header_id'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
            ...
            'work_order_cutting_header_id' => 'SPK',
