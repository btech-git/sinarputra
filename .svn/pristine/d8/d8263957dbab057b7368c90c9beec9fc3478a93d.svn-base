            ...
            <div class="divtable">
                <div class="divtablerow">
                    ...
                    <div class="divtablecell info hcolumn2value">
                        <?php
                        echo (isset($model->workOrderCuttingHeader)) ? CHtml::encode($model->workOrderCuttingHeader->getCodeNumber(WorkOrderCuttingHeader::CN_CONSTANT)) : 'No Work Order Header';
                        ?>
                    </div>
                </div>
                <div class="divtablerow">
                    ...
                    <div class="divtablecell info hcolumn2value">
                        <?php
                        echo (isset($model->workOrderCuttingHeader)) ? CHtml::encode($model->workOrderCuttingHeader->saleHeader->customer->company) : 'No Work Order Header';
                        ?>
                    </div>
                </div>
                <div class="divtablerow">
...
<?php if (isset($model->jobOrderDetailProducts) && $model->jobOrderDetailProducts != null): ?> 
    <table class="memo">
        <tr id="theader">
            ...
            <th style="text-align:center;border-bottom: 0px solid;">JAM MULAI</th>
            <th style="text-align:center;border-bottom: 0px solid;">JAM SELESAI</th>
        </tr>
        <tr class="theader">
            <th style="border-left: 1px solid;border-bottom: 2px solid;border-right: 1px solid" colspan="3">&nbsp;</th>
