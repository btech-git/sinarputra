...
class QualityControlMilingHeaderBase extends MonthlyTransactionActiveRecord {
    ...
    public function rules() {
        return array(
            ...
            array('cn_ordinal, cn_month, cn_year, production_miling_header_id, work_order_cutting_header_id, admin_id, is_delivered, is_inactive, admin_id_updated', 'numerical', 'integerOnly' => true),
            array('note, created_datetime, updated_datetime', 'safe'),
            // The following rule is used by search().
            array('id, cn_ordinal, cn_month, cn_year, date, note, production_miling_header_id, work_order_cutting_header_id, admin_id, is_delivered, is_inactive, admin_id_updated, created_datetime, updated_datetime', 'safe', 'on' => 'search'),
        );
    }
