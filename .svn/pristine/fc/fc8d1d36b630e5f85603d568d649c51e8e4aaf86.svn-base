...
<div style="font-weight: bold; text-align: center">
    ...
    <div style="font-size: larger">Laporan Pelunasan Detail Manual</div>
...
<table class="report">
    ...
    <?php foreach ($salePaymentSummary->dataProvider->data as $header): ?>
        <?php foreach ($header->manualSalePaymentDetails as $detail): ?>
            <tr>
                <td class="width1-1"><?php echo CHtml::encode($header->getCodeNumber(ManualSalePaymentHeader::CN_CONSTANT)); ?></td>
                ...
                <td class="width1-4"><?php echo CHtml::encode($detail->manualSaleInvoiceHeader->getCodeNumber(ManualSaleInvoiceHeader::CN_CONSTANT));?></td>
