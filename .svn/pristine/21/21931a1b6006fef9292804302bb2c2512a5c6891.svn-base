 ...
 * @property string $hardness_scale
 * @property string $number_heat
...
class ReceiveDetailBase extends ActiveRecord {
    ...
    public function rules() {
        return array(
            ...
            array('hardness_scale, number_heat', 'length', 'max' => 20),
            array('length, width, height, weight, weight_packing', 'length', 'max' => 10),
            array('memo', 'length', 'max' => 100),
            // The following rule is used by search().
            array('id, product_name, length, width, height, weight, weight_packing, serial_number, memo, product_category_id, receive_header_id, purchase_detail_id, location_id, is_inactive, hardness_scale, number_heat', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function search() {
        ...
        $criteria->compare('t.hardness_scale', $this->hardness_scale, true);
        $criteria->compare('t.number_heat', $this->number_heat, true);
