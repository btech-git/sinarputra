<div class="form">
    ...
    <div class="container">
        <div class="span-12">
            <div class="row">
                ...
                <?php echo CHtml::error($materialReceipt->header, 'date'); ?>
            </div>
            ...
            <div class="row">
                ...
                <?php echo CHtml::error($materialReceipt->header, 'date_receipt'); ?>
            </div>
            
            <div class="row">
                <?php echo CHtml::label('Kurir', ''); ?>
                <?php echo CHtml::activeTextField($materialReceipt->header, 'courier_name'); ?>
                <?php echo CHtml::error($materialReceipt->header, 'courier_name'); ?>
            </div>
            
            <div class="row">
                <?php echo CHtml::label('Catatan', ''); ?>
                <?php echo CHtml::activeTextArea($materialReceipt->header, 'note', array('rows' => 5, 'cols' => 30)); ?>
                <?php echo CHtml::error($materialReceipt->header, 'note'); ?>
            </div>
        </div>

        <div class="span-12 last">
            <?php if ($materialReceipt->header->isNewRecord): ?>
                <div class="row">
                    <?php echo CHtml::label('Customer', ''); ?>
                    <?php echo CHtml::activeTextField($materialReceipt->header, 'customer_id', array('readonly' => true, 'onclick' => '$("#customer-dialog").dialog("open"); return false;', 'onkeypress' => 'if (event.keyCode == 13) { $("#customer-dialog").dialog("open"); return false; }')); ?>
                    <?php echo CHtml::error($materialReceipt->header, 'customer_id'); ?>
                    ...
                    <?php $this->widget('zii.widgets.grid.CGridView', array(
                        ...
                        $("#' . CHtml::activeId($materialReceipt->header, 'customer_id') . '").val($.fn.yiiGridView.getSelection(id));
                        ...
                        else
                        {
                            $.ajax({
                                type: "POST",
                                dataType: "JSON",
                                url: "' . CController::createUrl('ajaxJsonCustomer', array('id' => $materialReceipt->header->id)) . '",
                                data: $("form").serialize(),
                        ...
                        $.ajax({
                            type: "POST",
                            url: "' . CController::createUrl('ajaxHtmlResetDetail', array('id' => $materialReceipt->header->id)) . '",
                            data: $("form").serialize(),
            ...
            <div class="row">
                ...
                <?php echo CHtml::encode(CHtml::value($materialReceipt->header, 'customer.name')); ?>
            ...
            <div class="row">
                ...
                <?php echo CHtml::encode(CHtml::value($materialReceipt->header, 'customer.company')); ?>
                <?php echo CHtml::closeTag('span'); ?>
            </div>
            ...
            <div class="row">
                ...
                <?php echo CHtml::encode(CHtml::value($materialReceipt->header, 'customer.address_main')); ?>
                <?php echo CHtml::closeTag('span'); ?>
            </div>
            ...
            <div class="row">
                ...
                <?php echo CHtml::encode(CHtml::value($materialReceipt->header, 'customer.invoice_due_days')); ?>
        ...
        <div id="detail_div">
            <?php $this->renderPartial('_detail', array('materialReceipt' => $materialReceipt)); ?>
        </div>
    ...
    <div>
        ...
        <?php echo CHtml::ajaxSubmitButton('Add Invoice', CController::createUrl('ajaxHtmlAddInvoices', array('id' => $materialReceipt->header->id)), array(
            'type' => 'POST',
