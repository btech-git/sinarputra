...
<div class="hide">
    <div class="form" style="text-align: center">
        ...
        <div class="row" >
            Customer
            <?php echo CHtml::dropDownList('CustomerId', $customerId, CHtml::listData(Customer::model()->findAll(array('order' => 'company ASC')), 'id', 'company'), array(
    ...
    <div class="clear"></div>
    <div class="right"><?php echo ReportHelper::sortText($deliverySummary->dataProvider->sort, array('Tanggal', 'Supplier', 'No. Penerimaan', 'No. PO')); ?></div>
    <div class="clear"></div>
</div>
