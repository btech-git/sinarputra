 ...
 */
class ProductionCuttingHeaderBase extends MonthlyTransactionActiveRecord {

    public function tableName() {
        return 'tblsp_production_cutting_header';
    }

    public function rules() {
        return array(
            array('cn_ordinal, cn_month, cn_year, date, production_planning_cutting_header_id, admin_id', 'required'),
            array('cn_ordinal, cn_month, cn_year, production_planning_cutting_header_id, admin_id, is_inactive, admin_id_updated', 'numerical', 'integerOnly' => true),
            array('note, time, created_datetime, updated_datetime', 'safe'),
            // The following rule is used by search().
            array('id, cn_ordinal, cn_month, cn_year, date, time, note, production_planning_cutting_header_id, admin_id, is_inactive, admin_id_updated, created_datetime, updated_datetime', 'safe', 'on' => 'search'),
        );
    }

    public function relations() {
        return array(
            'productionCuttingDetails' => array(self::HAS_MANY, 'ProductionCuttingDetail', 'production_cutting_header_id'),
            ...
            'qualityControlCuttingHeaders' => array(self::HAS_MANY, 'QualityControlCuttingHeader', 'production_cutting_header_id'),
        );
    }
