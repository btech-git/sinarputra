 ...
 */
class ProductionPlanningMilingHeaderBase extends MonthlyTransactionActiveRecord {

    public function tableName() {
        return 'tblsp_production_planning_miling_header';
    }
    ...
    public function relations() {
        return array(
            'productionMilingHeaders' => array(self::HAS_MANY, 'ProductionMilingHeader', 'production_planning_miling_header_id'),
            'productionPlanningMilingDetails' => array(self::HAS_MANY, 'ProductionPlanningMilingDetail', 'production_planning_miling_header_id'),
