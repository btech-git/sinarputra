<table style="border: 1px solid">
    ...
    <?php foreach ($materialPayment->details as $i => $detail): ?>
        <?php $tabIndex = $i * 2; ?>
        <tr style="background-color: azure">
            <td>
                <?php echo CHtml::activeHiddenField($detail, "[$i]material_invoice_header_id"); ?>
                <?php echo CHtml::encode($detail->materialInvoiceHeader->getCodeNumber(MaterialInvoiceHeader::CN_CONSTANT)); ?>
                <?php echo CHtml::error($detail, 'material_invoice_header_id'); ?>
            </td>
            <td>
                <?php echo CHtml::encode(Yii::app()->dateFormatter->format("d MMM yyyy", CHtml::value($detail, 'materialInvoiceHeader.date'))); ?>
            </td>
            <td>
            ...
            <td style="text-align: right">
                <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', CHtml::value($detail, 'materialInvoiceHeader.remaining_payment'))); ?>
            </td>
            <td style="text-align: center; margin-left: 20%">
            ...
            <td style="text-align: center; margin-left: 20%">
                <?php echo CHtml::activeTextField($detail, "[$i]amount", array('maxLength' => 18, 'size' => 8,
                    'onchange' => CHtml::ajax(array(
                        'type' => 'POST',
                        'dataType' => 'JSON',
                        'url' => CController::createUrl('ajaxJsonTotal', array('id' => $materialPayment->header->id, 'index' => $i)),
                ...
                <?php if ($detail->isNewRecord): ?>
                    <?php echo CHtml::button('Delete', array(
                        'onclick' => CHtml::ajax(array(
                            'type' => 'POST',
                            'url' => CController::createUrl('ajaxHtmlRemoveDetail', array('id' => $materialPayment->header->id, 'index' => $i)),
                            'update' => '#detail_div',
                        )),
                    )); ?>
                <?php else: ?>
    ...
    <tr style="background-color: aquamarine">
        ...
        <td style="text-align: right; font-weight: bold">
            <span id="receivable">
                <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', CHtml::value($materialPayment, 'totalReceivable'))); ?>
            </span>
        </td>
        <td></td>
    </tr>
    <tr style="background-color: aquamarine">
        ...
        <td style="text-align: right;font-weight: bold">
            <span id="payment">
                <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', CHtml::value($materialPayment, 'payment'))); ?>
            </span>
        </td>
        <td></td>
    </tr>
    <tr style="background-color: aquamarine">
        ...
        <td style="text-align: right; font-weight: bold">
            <span id="additional_payment_1">
                <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', CHtml::value($materialPayment, 'additional_payment_1'))); ?>
            </span>
        </td>
        <td>&nbsp;</td>
    </tr>
    <tr style="background-color: aquamarine"> 
        ...
        <td style="text-align: right; font-weight: bold">
            <span id="additional_payment_2">
                <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', CHtml::value($materialPayment, 'additional_payment_2'))); ?>
            </span>
        </td>
        <td>&nbsp;</td>
    </tr>
    <tr style="background-color: aquamarine">
        ...
        <td style="text-align: right; font-weight: bold">
            <span id="remaining">
                <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', CHtml::value($materialPayment, 'remaining'))); ?>
            </span>
        </td>
        <td></td>
    </tr>
