...
class StockCheckSummary extends CComponent {
    ...
    public function setupSorting() {
        ...
        //$this->dataProvider->sort->defaultOrder = 't.product_name';
    }

    public function setupFilter($filters) {

        $this->dataProvider->criteria->compare('t.product_category_id', $filters['productCategoryId']);
        $this->dataProvider->criteria->compare('t.product_name', $filters['productName'], TRUE);
    }
