<table style="border: 1px solid">
	...
	<?php foreach ($quotationReturn->details as $i=>$detail): ?>
		...
		<tr style="background-color: azure">
			...
			<td style="text-align:center">
				<?php echo CHtml::activeTextField($detail, "[$i]quantity", array('size'=>5, 'maxlength'=>10,
					'onchange'=> CHtml::ajax(array(
						'type' => 'POST',
						'dataType' => 'JSON',
						'url' => CController::createUrl('ajaxJsonTotal', array('id' => $quotationReturn->header->id, 'index' => $i)),
			...
			<td style="text-align: right">
				<?php echo CHtml::activeTextField($detail, "[$i]unit_price", array('size'=>5, 'maxlength'=>10,
					'onchange'=> CHtml::ajax(array(
						'type' => 'POST',
						'dataType' => 'JSON',
						'url' => CController::createUrl('ajaxJsonTotal', array('id' => $quotationReturn->header->id, 'index' => $i)),
				...
				<?php if ($detail->isNewRecord): ?>
					<?php echo CHtml::button('Delete', array(
						'onclick'=>CHtml::ajax(array(
							'type'=>'POST',
							'url'=>CController::createUrl('ajaxHtmlRemoveDetail', array('id'=>$quotationReturn->header->id, 'index'=>$i)),
							'update'=>'#detail_div',
						)),
					)); ?>
				<?php else: ?>
	...
	<tr style="background-color: aquamarine">
        ...
        <td style="text-align: right; font-weight: bold">
            <span id="sub_total">
                <?php echo CHtml::encode(Yii::app()->numberFormatter->format('#,##0.00', $quotationReturn->subTotal)); ?>
            </span>
        </td>
        <td></td>
    </tr>
