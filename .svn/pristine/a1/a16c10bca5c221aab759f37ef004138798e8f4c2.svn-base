        ...
        <div class="divtablecell hcolumn1">
            <div class="divtable">
                ...
                <div class="divtablerow">
                    ...
                    <div class="divtablecell info hcolumn2value"><?php echo CHtml::encode(CHtml::value($model, 'workOrderReplacementHeader.workOrderCuttingHeader.saleHeader.customer_order_number')); ?></div>
                </div>
            </div>
        </div>
        <div class="divtablecell hcolumn2">
            <div class="divtable">
                <div class="divtablerow">
                    ...
                    <div class="divtablecell info hcolumn2value"><?php echo CHtml::encode(CHtml::value($model, 'workOrderReplacementHeader.workOrderCuttingHeader.saleHeader.customer.company')); ?></div>
                </div>
                <div class="divtablerow">
                    <div class="divtablecell info hcolumn2header">&nbsp;</div>
                    <div class="divtablecell info hcolumn2value"><?php echo CHtml::encode(nl2br(CHtml::value($model, 'workOrderReplacementHeader.workOrderCuttingHeader.saleHeader.customer.address'))); ?></div>
                </div>
                <div class="divtablerow">
                    <div class="divtablecell info hcolumn2header" style="font-weight: bold">Sales</div>
                    <div class="divtablecell info hcolumn2value"><?php echo CHtml::encode(CHtml::value($model, 'workOrderReplacementHeader.workOrderCuttingHeader.saleHeader.customer.employee.name')); ?></div>
                </div>
            </div>
        </div>
    </div>
...
<table style="border: 1px solid">
    ...
    <?php foreach ($model->productionPlanningCuttingDetails as $planningDetail): ?>
        <?php foreach ($planningDetail->workOrderReplacementDetail->workOrderCuttingDetailMaterials as $detail): ?>
