...
class JournalVoucherHeaderBase extends MonthlyTransactionActiveRecord {
    ...
    public function tableName() {
        return 'tblsp_journal_voucher_header';
    }

    public function rules() {
        return array(
            array('cn_ordinal, cn_month, cn_year, date, admin_id', 'required'),
            array('cn_ordinal, cn_month, cn_year, admin_id, is_inactive, admin_id_updated', 'numerical', 'integerOnly' => true),
            array('note, created_datetime, updated_datetime', 'safe'),
            // The following rule is used by search().
            array('id, cn_ordinal, cn_month, cn_year, date, note, admin_id, is_inactive, admin_id_updated, created_datetime, updated_datetime', 'safe', 'on' => 'search'),
        );
    }
